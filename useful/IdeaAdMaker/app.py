...
def main():
    ...
    with st.form('product_type_form', clear_on_submit=True):
        ...
        if submitted and replicate_api.startswith('r8'):
            ...
            with st.spinner("Painting some beautiful logos..."):
                ...
                logo_model1 = Replicate(model="galleri5/icons:ee00da8a2bc30c2809d1038c36ea3b567a5d9a82191e444b60dd2883f0905a75",REPLICATE_API_TOKEN=replicate_api)
                logo_model2 = Replicate(model="mejiabrayan/logoai:67ed00e8999fecd32035074fa0f2e9a31ee03b57a8415e6a5e2f93a242ddd8d2",REPLICATE_API_TOKEN=replicate_api)
                logo_model3 = Replicate(model="cjwbw/magifactory-t-shirt-diffusion:8d24b92f902aef5df3133aa6fce518d1f86580e5cdf1adecc18693f1f3ba6bcb",REPLICATE_API_TOKEN=replicate_api)
